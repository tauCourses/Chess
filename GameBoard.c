...
bool isBishopLegalDirection(Board board, Location* org, Location* des,
                            int (*addOrSubX)(int,int), int (*addOrSubY)(int,int))
{
    int i = 1;
...
PLAYER_COLOR getPieceColor(char piece) //assume piece is a legal char
{
